...
/**
 * A MapReduce job that processes word frequency data to find and emit the top 50
 * most frequent words overall.
 */
public class TopFrequentWords extends Configured implements Tool {

    /**
     * Parses the word count input file and emits each word with its total count.
     */
    ...
    /**
     * Maintains a local priority queue (min-heap) of the top 50 most frequent words
     * and writes them out in the final cleanup phase.
     */
    ...
    public static void main(String[] args) throws Exception {
        int res = ToolRunner.run(new Configuration(), new TopFrequentWords(), args);
        System.exit(res);
    }
}